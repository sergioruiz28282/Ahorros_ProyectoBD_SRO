...
CREATE TABLE `TRANSACCION` (
  `numero_transaccion` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_TRANSACCION_METAS_AHORRO` (`METAS_AHORRO_id_meta`),
...
) ENGINE=InnoDB AUTO_INCREMENT=999415 DEFAULT CHARSET=utf8mb3;
